function calcularTest() {
    ...
    document.getElementById("caballo").innerHTML = "La Família";
    ...
    document.getElementById("rata").innerHTML = "Lo que más odia";
    ...
    document.getElementById("verde").innerHTML = "Siempre estará en tu memoría";
}